import BannerImg from '@/assets/image/Elio/Elio.webp';
import LogoImg from "@/assets/image/Elio/ElioLogo.png";
import * as S from '@/pages/MovieDetail95/components/Banner/Banner.style';
